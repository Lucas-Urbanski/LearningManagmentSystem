    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.map((course) => (
          <div
            key={course.id}
            className="group p-6 bg-gradient-to-br from-white/20 to-white border border-zinc-300 rounded-2xl shadow-sm hover:shadow-md transition-all cursor-pointer"
          >
